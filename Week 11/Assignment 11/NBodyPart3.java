 ...
 *  Name:    
 *
 *  Description: Simulates the universe, starting at time t = 0.0, and
 *  continuing as long as t < T, by repeatedly calculating the location of
 *  each of the bodies. Animates the results to standard drawing using StdDraw.
 * 
 ******************************************************************************/

public class NBodyPart3 {
